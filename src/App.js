...
const F = {
  ...
  veludo_novo:   "https://res.cloudinary.com/djeliz676/image/upload/v1779834795/veluno_novo_jdahvf.jpg",
  veludo_triplo: "https://res.cloudinary.com/djeliz676/image/upload/v1779834912/veludo_triplo_t19qcu.jpg",
  laco_branco:   "https://res.cloudinary.com/djeliz676/image/upload/v1779835084/la%C3%A7o_branco_iinaou.jpg",
};
const PH = F.logo;
...
const PRODUCTS = [
  ...
  { sku: "VNOVO",   name: "Laço Veludo Novo",                      subtitle: "Linha premium",     category: "Veludo",    material: "100% poliéster",            acabamento: AP,  prazo: P30, estoque: 500, preco: PRECO_UN, desc: "Novo laço confeccionado em veludo premium.",                                                                         cores: cVGBC,  photo: F.veludo_novo,  ...TC.V, sizes: [{ label: "30cm",  ref: "30VN",        min: 10 }, { label: "40cm",  ref: "40VN",        min: 8  }, { label: "50cm", ref: "50VN", min: 6 }] },
  { sku: "VTRI",    name: "Laço Veludo Triplo",                    subtitle: "Triplo luxo",       category: "Veludo",    material: "100% poliéster",            acabamento: AAR, prazo: P30, estoque: 500, preco: PRECO_UN, desc: "Laço triplo confeccionado em Veludo, com estrutura robusta e efeito cascata.",                                       cores: cVGBC,  photo: F.veludo_triplo,...TC.V, sizes: [{ label: "40cm",  ref: "40VTri",      min: 8  }, { label: "60cm",  ref: "60VTri",      min: 4  }, { label: "80cm", ref: "80VTri", min: 3 }] },
  { sku: "LBCO",    name: "Laço Veludo Branco",                    subtitle: "20cm a 40cm",       category: "Veludo",    material: "100% poliéster",            acabamento: AP,  prazo: P30, estoque: 500, preco: PRECO_UN, desc: "Laço clássico confeccionado em Veludo na cor Branco.",                                                               cores: cBR,    photo: F.laco_branco,  ...TC.V, sizes: [{ label: "20cm",  ref: "20LBco",      min: 12 }, { label: "30cm",  ref: "30LBco",      min: 10 }, { label: "40cm", ref: "40LBco", min: 8 }] },
  // ── ESTAMPADO ───────────────────────────────────────────────────────────────
  ...
  { sku: "VXP",     name: "Laço Veludo Vermelho Xadrez/Preto",     subtitle: "Flanela xadrez",    category: "Estampado", material: "100% poliéster",            acabamento: AE,  prazo: P30, estoque: 500, preco: PRECO_UN, desc: "Laço confeccionado em veludo tradicional, com flanela xadrez Vermelho/Preto central.",                              cores: cVP,    photo: F.vxp,          ...TC.E, sizes: [{ label: "20cm",  ref: "20VXP",       min: 12 }, { label: "30cm",  ref: "30VXP",       min: 10 }, { label: "40cm", ref: "40VXP", min: 8 }] },
  ...
  // ── SALDÃO ──────────────────────────────────────────────────────────────────
  { sku: "BJR",      name: "Bota Juta Renda",                       subtitle: "50cm",        category: "Saldão", material: "100% Poliéster", acabamento: "", prazo: P30, estoque:  7, preco: 59.80, desc: "Bota decorativa em Juta com Renda.",                                     cores: cNAT, photo: F.bjr,          ...TC.S, sizes: [{ label: "50cm",  ref: "50BJR",      min: 5 }] },
  { sku: "RNOEL",    name: "Roupa do Noel",                         subtitle: "Tam. único",  category: "Saldão", material: "100% Poliéster", acabamento: "", prazo: P30, estoque: 500, preco: PRECO_UN, desc: "Roupa decorativa do Papai Noel.",                                  cores: cVM,  photo: F.roupa_noel,   ...TC.S, sizes: [{ label: "Único", ref: "RNOEL",     min: 5 }] },
  { sku: "SFVCBR",   name: "Saia Árvore Feltro Vermelho Cervo Branco", subtitle: "1MT",    category: "Saldão", material: "100% Poliéster", acabamento: "", prazo: P30, estoque:  2, preco: 89.60, desc: "Saia para árvore em feltro vermelho com cervo branco.",                  cores: cVM,  photo: F.sfvcbr,       ...TC.S, sizes: [{ label: "1MT",   ref: "1SFVCBR",    min: 1 }] },
  { sku: "BFVCBR",   name: "Bota Feltro Vermelho Cervo Branco",     subtitle: "50cm",        category: "Saldão", material: "100% Poliéster", acabamento: "", prazo: P30, estoque: 12, preco: 39.80, desc: "Bota em feltro vermelho com cervo branco.",                              cores: cVM,  photo: F.bfvcbr,       ...TC.S, sizes: [{ label: "50cm",  ref: "50BFVCBR",   min: 1 }] },
  { sku: "SFCCXD",   name: "Saia Árvore Feltro Cru Cervo Xadrez",   subtitle: "1MT",         category: "Saldão", material: "100% Poliéster", acabamento: "", prazo: P30, estoque:  4, preco: 89.60, desc: "Saia para árvore em feltro cru com cervo xadrez.",                       cores: cVM,  photo: F.sfccxd,       ...TC.S, sizes: [{ label: "1MT",   ref: "1SFCCXD",    min: 1 }] },
  { sku: "BFCCXDZ",  name: "Bota Feltro Cru Cervo Xadrez",          subtitle: "50cm",        category: "Saldão", material: "100% Poliéster", acabamento: "", prazo: P30, estoque:  6, preco: 39.80, desc: "Bota em feltro cru com cervo xadrez.",                                   cores: cVM,  photo: F.bfccxdz,      ...TC.S, sizes: [{ label: "50cm",  ref: "50BFCCXDZ",  min: 1 }] },
  { sku: "SFXDP",    name: "Saia Árvore Flanelada Xadrez/Pelúcia",  subtitle: "1MT",         category: "Saldão", material: "100% Poliéster", acabamento: "", prazo: P30, estoque: 500, preco: PRECO_UN, desc: "Saia para árvore em tecido flanelado xadrez com pelúcia.",           cores: cVM,  photo: PH,             ...TC.S, sizes: [{ label: "1MT",   ref: "1SFXDP",     min: 5 }] },
  { sku: "BXFDZP",   name: "Bota Flanelada Xadrez/Pelúcia",         subtitle: "50cm",        category: "Saldão", material: "100% Poliéster", acabamento: "", prazo: P30, estoque: 10, preco: 68.70, desc: "Bota em tecido flanelado xadrez com pelúcia.",                           cores: cNAT, photo: F.bota_flanela, ...TC.S, sizes: [{ label: "50cm",  ref: "50BXFDZP",   min: 1 }] },
  { sku: "SFVDB",    name: "Saia Árvore Feltro Verde Bengala",       subtitle: "1MT",         category: "Saldão", material: "100% Poliéster", acabamento: "", prazo: P30, estoque:  2, preco: 129.60, desc: "Saia para árvore em feltro verde bengala.",                             cores: cNAT, photo: F.sfvdb,        ...TC.S, sizes: [{ label: "1MT",   ref: "1SFVDB",     min: 1 }] },
  { sku: "BFVB",     name: "Bota Feltro Verde Bengala",              subtitle: "50cm",        category: "Saldão", material: "100% Poliéster", acabamento: "", prazo: P30, estoque:  2, preco: 79.90, desc: "Bota em feltro verde bengala.",                                          cores: cNAT, photo: F.bfvb,         ...TC.S, sizes: [{ label: "50cm",  ref: "50BFVB",     min: 1 }] },
  { sku: "SFVOC",    name: "Saia Árvore Feltro Verde Oliva Cervo",   subtitle: "1MT",         category: "Saldão", material: "100% Poliéster", acabamento: "", prazo: P30, estoque:  1, preco: 79.30, desc: "Saia para árvore em feltro verde oliva com cervo e guizo.",             cores: cNAT, photo: F.sfvoc,        ...TC.S, sizes: [{ label: "1MT",   ref: "1SFVOC",     min: 1 }] },
  { sku: "BFVOC",    name: "Bota Feltro Verde Oliva Cervo",          subtitle: "50cm",        category: "Saldão", material: "100% Poliéster", acabamento: "", prazo: P30, estoque:  4, preco: 29.80, desc: "Bota em feltro verde oliva com cervo.",                                  cores: cNAT, photo: F.bfvoc,        ...TC.S, sizes: [{ label: "50cm",  ref: "50BFVOC",    min: 1 }] },
  { sku: "SFVGPT",   name: "Saia Árvore Feltro Gatinho Preto",       subtitle: "1MT",         category: "Saldão", material: "100% Poliéster", acabamento: "", prazo: P30, estoque:  1, preco: 119.40, desc: "Saia para árvore em feltro com gatinho preto.",                         cores: cNAT, photo: F.sfvgpt,       ...TC.S, sizes: [{ label: "1MT",   ref: "1SFVGPT",    min: 1 }] },
  { sku: "BFVGPT",   name: "Bota Feltro Vermelho Gatinho Preto",     subtitle: "50cm",        category: "Saldão", material: "100% Poliéster", acabamento: "", prazo: P30, estoque: 500, preco: PRECO_UN, desc: "Bota em feltro vermelho com gatinho preto.",                          cores: cNAT, photo: F.bfvgpt,       ...TC.S, sizes: [{ label: "50cm",  ref: "50BFVGPT",   min: 5 }] },
  { sku: "SFVCPT",   name: "Saia Árvore Feltro Vermelho Cachorro Preto", subtitle: "1MT",    category: "Saldão", material: "100% Poliéster", acabamento: "", prazo: P30, estoque:  3, preco: 129.40, desc: "Saia para árvore em feltro vermelho com cachorrinho preto.",          cores: cNAT, photo: F.sfvcpt,       ...TC.S, sizes: [{ label: "1MT",   ref: "1SFVCPT",    min: 1 }] },
  { sku: "BFVMCPT",  name: "Bota Feltro Vermelho Cachorrinho Preto", subtitle: "50cm",        category: "Saldão", material: "100% Poliéster", acabamento: "", prazo: P30, estoque:  5, preco: 69.70, desc: "Bota em feltro vermelho com cachorrinho preto.",                         cores: cNAT, photo: F.bfvmcpt,      ...TC.S, sizes: [{ label: "50cm",  ref: "50BFVMCPT",  min: 1 }] },
  { sku: "SFVEP",    name: "Saia Árvore Feltro Verde Espinha Peixe", subtitle: "1MT",         category: "Saldão", material: "100% Poliéster", acabamento: "", prazo: P30, estoque:  4, preco: 79.50, desc: "Saia para árvore em feltro verde espinha de peixe.",                    cores: cNAT, photo: PH,             ...TC.S, sizes: [{ label: "1MT",   ref: "1SFVEP",     min: 1 }] },
  { sku: "BFVDEPX",  name: "Bota Feltro Verde Espinha Peixe",        subtitle: "50cm",        category: "Saldão", material: "100% Poliéster", acabamento: "", prazo: P30, estoque: 13, preco: 49.80, desc: "Bota em feltro verde espinha de peixe.",                                cores: cNAT, photo: F.bfvdepx,      ...TC.S, sizes: [{ label: "50cm",  ref: "50BFVDEPX",  min: 1 }] },
  { sku: "SFVO",     name: "Saia Árvore Vermelho Ossinho",            subtitle: "1MT",         category: "Saldão", material: "100% Poliéster", acabamento: "", prazo: P30, estoque: 500, preco: PRECO_UN, desc: "Saia para árvore em feltro vermelho com ossinho.",                   cores: cNAT, photo: PH,             ...TC.S, sizes: [{ label: "1MT",   ref: "1SFVO",      min: 5 }] },
  { sku: "BFVO",     name: "Bota Feltro Verde Ossinho",               subtitle: "50cm",        category: "Saldão", material: "100% Poliéster", acabamento: "", prazo: P30, estoque: 500, preco: PRECO_UN, desc: "Bota em feltro verde com ossinho.",                                  cores: cNAT, photo: PH,             ...TC.S, sizes: [{ label: "50cm",  ref: "50BFVO",     min: 5 }] },
  ...
  { sku: "BVPArDr",  name: "Bota Velboa/Pelúcia Árvore",               subtitle: "50cm",        category: "Saldão", material: "100% Poliéster", acabamento: "", prazo: P30, estoque: 500, preco: PRECO_UN, desc: "Bota em velboa/pelúcia com árvore.",                                 cores: cNAT, photo: PH,             ...TC.S, sizes: [{ label: "50cm",  ref: "50BVPArDr",  min: 5 }] },
  ...
  { sku: "SVVPN",    name: "Saia Velboa Vermelho Papai Noel",           subtitle: "1MT",         category: "Saldão", material: "100% Poliéster", acabamento: "", prazo: P30, estoque: 500, preco: PRECO_UN, desc: "Saia para árvore em velboa vermelho com Papai Noel.",                cores: cNAT, photo: PH,             ...TC.S, sizes: [{ label: "1MT",   ref: "1SVVPN",     min: 5 }] },
  ...
  { sku: "SVVBBR",   name: "Saia Velboa Vermelho Bolas Pelúcia",        subtitle: "1MT",         category: "Saldão", material: "100% Poliéster", acabamento: "", prazo: P30, estoque: 500, preco: PRECO_UN, desc: "Saia para árvore em velboa vermelho com bolas de pelúcia.",          cores: cNAT, photo: PH,             ...TC.S, sizes: [{ label: "1MT",   ref: "1SVVBBR",    min: 5 }] },
  ...
  return (
    <div onClick={e => e.stopPropagation()} style={{ background: VERDES, borderRadius: 10, padding: "10px", border: `1px solid ${VERDE}33` }}>
      ...
      <div style={{ display: "flex", gap: 4, flexWrap: "wrap", marginBottom: 8 }}>
        {p.sizes.map((s, i) => (
          <button key={i} onClick={() => handleSz(i)} style={{ padding: "4px 8px", borderRadius: 6, background: sz === i ? VERDE : CARD, color: sz === i ? "#fff" : TEXT2, border: sz === i ? `1px solid ${VERDE2}` : `1px solid ${BORDER}`, fontSize: 9, fontWeight: 700, fontFamily: "'DM Mono',monospace", cursor: "pointer" }}>{s.label}</button>
        ))}
      </div>
      {/* Cor */}
      {p.cores.length > 1 && <>
