...
const PRODUCTS = [
  ...
  { sku:"BVVPN",    name:"Bota Velboz Cru/Rosê Laço",                    subtitle:"50cm",                   category:"Saldão",    material:"100% Poliéster",            acabamento:"",   prazo:P30,           estoque:500, preco:PRECO_UN, desc:"Bota em velboz cru/rosê com laço.",                                                                       cores:cNAT,   photo:F.bvvpn,       ...TC.S, sizes:[{label:"50cm",ref:"50BVVPN",min:1,estoque:500}] },{label:"100cm",ref:"1SOS",min:1,estoque:500}] },
  ...
  { sku:"SNPop",    name:"Saia Natalina POP Árvore",                     subtitle:"60 a 120cm",             category:"Saldão",    material:"100% Poliéster",            acabamento:"Cianinha branca e botão.",                 prazo:P30, estoque:95,  preco:29.90,    desc:"Saia Natalina em Feltro, com aplicação Árvores.",                        cores:cUNI,   photo:F.saia_velb_pol,...TC.S,sizes:[{label:"60cm",ref:"60SNPop",min:30,estoque:30,preco:29.90},{label:"80cm",ref:"80SNPop",min:30,estoque:30,preco:34.90},{label:"100cm",ref:"100SNPop",min:30,estoque:30,preco:39.90},{label:"120cm",ref:"120SNPop",min:5,estoque:5,preco:45.90}] },
