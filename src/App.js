...
const PRODUCTS = [
  ...
  { sku:"VFIXDZ",   name:"Laço Veludo Vermelho Fita Xadrez",          subtitle:"Fita xadrez",            category:"Estampado", material:"100% poliéster",            acabamento:AE,   prazo:P30, preco:PRECO_UN, desc:"Laço confeccionado em Veludo Tradicional, com fita xadrez decorativa central.",                          cores:[{name:"Vermelho",hex:"#C0392B"}],    photo:F.vfixdz,      ...TC.E, sizes:[{label:"20cm",ref:"20VFiXdz",preco:26.90},{label:"30cm",ref:"30VFiXdz",preco:38.90},{label:"40cm",ref:"40VFiXdz",preco:48.90}] },
