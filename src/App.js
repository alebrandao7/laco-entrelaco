...
const PRODUCTS = [
  ...
  { sku:"LDR",      name:"Laço Lamê Dourado",                         subtitle:"Brilho metálico",        category:"Lamê",      material:"100% poliéster metalizado", acabamento:AE,   prazo:P30, preco:PRECO_UN, desc:"Laço tradicional confeccionado em Lamê dourado; brilho intenso.",                                         cores:cLD,    photo:F.ldr,         ...TC.L, sizes:[{label:"20cm",ref:"20LDR",preco:43.00},{label:"30cm",ref:"30LDR",preco:61.90},{label:"40cm",ref:"40LDR",preco:98.90}] },
