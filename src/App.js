...
const F = {
  ...
  lame_dourado:   "https://res.cloudinary.com/djeliz676/image/upload/f_auto,q_auto/v1779736824/LOGOS_daguvp.png", // foto provisória
  laco_gravata4m: "https://res.cloudinary.com/djeliz676/image/upload/v1781705568/laco_novo_gravata4m_femlxg.jpg",
  logo:         "https://res.cloudinary.com/djeliz676/image/upload/f_auto,q_auto/v1779736824/LOGOS_daguvp.png",
  laco_gravata_tripla: "https://res.cloudinary.com/djeliz676/image/upload/v1779990308/laco_gravata_tripla_ekuhtx.jpg",
  vaimin:              "https://res.cloudinary.com/djeliz676/image/upload/v1779991951/vaimin_vtqtgd.jpg",
  laco_soutache:       "https://res.cloudinary.com/djeliz676/image/upload/v1779992238/laco_soutchj_r6ua5b.jpg",
  escap_listra:        "https://res.cloudinary.com/djeliz676/image/upload/v1779984946/escap_listra_s9lxth.jpg",
  escap_flor:          "https://res.cloudinary.com/djeliz676/image/upload/v1779984946/escap_flor_ccn1rb.jpg",
  bota_pelucia_dec:    "https://res.cloudinary.com/djeliz676/image/upload/v1779984531/bota_pelucia_decorada_jdor46.jpg",
  bota_alce:           "https://res.cloudinary.com/djeliz676/image/upload/v1779984667/bota_alce_atj0n4.jpg",
  bota_dourada:        "https://res.cloudinary.com/djeliz676/image/upload/v1779984755/bota_dourada_rh1a4e.jpg",
};
const PH = F.logo;
const PRECO_UN = 10.00;

const cVVM   = [{ name: "Vermelho", hex: "#C0392B", photo: F.vvm_verm }];
const cVGBC  = [{ name: "Vermelho", hex: "#C0392B" }, { name: "Verde", hex: "#2D5A27" }, { name: "Branco", hex: "#F5F5F0" }, { name: "Champagne", hex: "#C8B89A" }, { name: "Dourado", hex: "#CFB53B" }];
const cVGBCA = [{ name: "Vermelho", hex: "#C0392B" }, { name: "Verde", hex: "#2D5A27" }, { name: "Branco", hex: "#F5F5F0" }, { name: "Areia", hex: "#C8B49A" }];
...
const cVD    = [{ name: "Vermelho + Dourado", hex: "#C0392B" }, { name: "Dourado", hex: "#CFB53B" }];
...
const PRODUCTS = [
  { sku:"EVV",      name:"Escapulário Veludo Vermelho",                subtitle:"200cm",                  category:"Veludo",    material:"100% poliéster",            acabamento:ACF,  prazo:P30, preco:PRECO_UN, desc:"Escapulário 1mt confeccionado em Veludo Vermelho tradicional.",                                           cores:[{name:"Vermelho",hex:"#C0392B"}],    photo:F.escapulario, ...TC.V, sizes:[{label:"200cm",ref:"200EVV",preco:94.90}] },
  { sku:"EVVDec",     name:"Escapulário Veludo Vermelho Decorado",     subtitle:"200cm",           category:"Veludo",  material:"100% poliéster", acabamento:"Costura francesa e galho natalino.", prazo:P30, preco:159.90, desc:"Escapulário 1mt confeccionado em Veludo Vermelho com decoração natalina.", cores:[{name:"Vermelho",hex:"#C0392B"}], photo:F.escap_flor, ...TC.V, sizes:[{label:"200cm",ref:"200EVVDec",preco:159.90}] },
  { sku:"EVVLis",     name:"Escapulário Veludo Vermelho Listra",       subtitle:"200cm",           category:"Veludo",  material:"100% poliéster", acabamento:"Costura francesa e galho natalino.", prazo:P30, preco:183.90, desc:"Escapulário 1mt confeccionado em Veludo Vermelho com listra natalina.", cores:[{name:"Vermelho",hex:"#C0392B"}], photo:F.escap_listra, ...TC.V, sizes:[{label:"200cm",ref:"200EVVLis",preco:183.90}] },
  { sku:"EVVXdz",   name:"Escapulário Veludo Vermelho Xadrez",         subtitle:"200cm",                  category:"Veludo",    material:"100% poliéster",            acabamento:"Costura francesa e galho natalino.", prazo:P30, preco:PRECO_UN, desc:"Escapulário em Veludo Vermelho com decoração xadrez natalino.", cores:[{name:"Vermelho",hex:"#C0392B"}], photo:F.escap_xdz, ...TC.V, sizes:[{label:"200cm",ref:"200EVVXdz",preco:183.90}] },
  { sku:"LDR",      name:"Laço Lamê Dourado",                         subtitle:"Brilho metálico",        category:"Lamê",      material:"100% poliéster metalizado", acabamento:AE,   prazo:P30, preco:PRECO_UN, desc:"Laço tradicional confeccionado em Lamê dourado; brilho intenso.",                                         cores:cLD,    photo:F.ldr,         ...TC.L, sizes:[{label:"20cm",ref:"20LDR",preco:26.90},{label:"30cm",ref:"30LDR",preco:39.90},{label:"40cm",ref:"40LDR",preco:56.20}] },
  { sku:"TL",       name:"Laço Tecido Listra Vermelho/Branco",        subtitle:"Listrado clássico",      category:"Estampado", material:"100% algodão",              acabamento:AE,   prazo:P30, preco:PRECO_UN, desc:"Laço tradicional confeccionado em tecido listrado.",                                                      cores:cVB,    photo:F.tl,          ...TC.E, sizes:[{label:"20cm",ref:"20TL",preco:21.90},{label:"30cm",ref:"30TL",preco:33.90},{label:"40cm",ref:"40TL",preco:44.70}] },
  { sku:"VAL",      name:"Laço Veludo Ale",                           subtitle:"20cm a 40cm",            category:"Veludo",    material:"100% poliéster",            acabamento:APL,  prazo:P30, preco:PRECO_UN, desc:"Laço tradicional confeccionado em Veludo Cristal.",                                                       cores:[...cVGBCA,{name:"Lamê Dourado",hex:"#CFB53B",photo:F.lame_dourado,material:"100% poliéster metalizado"}],  photo:F.val,         ...TC.V, sizes:[{label:"20cm",ref:"20VAl",preco:26.90},{label:"30cm",ref:"30VAl",preco:39.90},{label:"40cm",ref:"40VAl",preco:56.20}] },
  { sku:"VAleBGSol",  name:"Laço Veludo Ale Borboleta Gravata Solta",  subtitle:"60cm",            category:"Veludo",  material:"100% poliéster", acabamento:"Estrutura interna com placa, arame e costura francesa.", prazo:P30, preco:289.00, desc:"Laço confeccionado em Veludo tradicional, com borboleta extra larga e gravata solta.", cores:[{name:"Vermelho",hex:"#C0392B"},{name:"Verde",hex:"#2D5A27"},{name:"Branco",hex:"#F5F5F0"},{name:"Areia",hex:"#C8B49A"},{name:"Lamê Dourado",hex:"#CFB53B",photo:F.lame_dourado,material:"100% poliéster metalizado"}], photo:F.laco_branco, ...TC.V, sizes:[{label:"60cm",ref:"60VAleBGSol",preco:289.00}] },
  { sku:"VAlMinGL", name:"Laço Veludo Ale Min. Gravata Longa",        subtitle:"50cm e 80cm",            category:"Veludo",    material:"100% poliéster",            acabamento:AAR,  prazo:P30, preco:PRECO_UN, desc:"Laço com borboleta extra larga e Gravata extra longa.",                                                   cores:[...cVGBCA,{name:"Lamê Dourado",hex:"#CFB53B",photo:F.lame_dourado,material:"100% poliéster metalizado"}],photo:F.veludo_novo,  ...TC.V, sizes:[{label:"50cm",ref:"50VAlMinGL",preco:199.00},{label:"80cm",ref:"80VAlMinGL",preco:289.00},{label:"150cm",ref:"150VAlMinGL",preco:549.00}] },

  { sku:"LVAG4",       name:"Laço Veludo Ale Triplo Gravata",         subtitle:"400cm",  category:"Veludo", material:"100% poliéster", acabamento:"Estrutura interna com placas e arame; costura francesa.", prazo:P30, preco:698.00, desc:"Confeccionado em Veludo Cristal, com Gravata Extra Longa de 4 metros que cria efeito cascata ao descer pela árvore ou coluna.", cores:[...cVGBCA,{name:"Lamê Dourado",hex:"#CFB53B",photo:F.lame_dourado,material:"100% poliéster metalizado"}], photo:F.laco_gravata4m, ...TC.V, sizes:[{label:"400cm",ref:"LVA/G4",preco:698.00},{label:"300cm",ref:"LVA/G3",preco:598.00}] },
  { sku:"VAlTri",   name:"Laço Veludo Ale Triplo",                    subtitle:"90cm",                   category:"Veludo",    material:"100% poliéster",            acabamento:AAR,  prazo:P30, preco:PRECO_UN, desc:"Laço com borboleta tripla e gravata tradicional.",                                                        cores:[...cVGBCA,{name:"Lamê Dourado",hex:"#CFB53B",photo:F.lame_dourado,material:"100% poliéster metalizado"}],photo:F.veludo_triplo,...TC.V, sizes:[{label:"90cm",ref:"90VAlTri",preco:389.80}] },
  { sku:"VALLIND",  name:"Laço Veludo Ale Lind",              subtitle:"30cm a 90cm",            category:"Veludo",    material:"100% poliéster",            acabamento:AAR,  prazo:P30, preco:PRECO_UN, desc:"Laço duplo confeccionado em Veludo Cristal, com Gravata Longa que cria efeito cascata.",                  cores:[...cVGBCA,{name:"Lamê Dourado",hex:"#CFB53B",photo:F.lame_dourado,material:"100% poliéster metalizado"}],  photo:F.val_lind,    ...TC.V, sizes:[{label:"30cm",ref:"30VAl/Lind",preco:58.00},{label:"60cm",ref:"60VAl/Lind",preco:208.90},{label:"90cm",ref:"90VAl/Lind",preco:398.00}] },
  { sku:"VALGL",    name:"Laço Veludo Cristal Gravata Longa",         subtitle:"30cm a 50cm",            category:"Veludo",    material:"100% poliéster",            acabamento:AP,   prazo:P30, preco:PRECO_UN, desc:"Confeccionado em Veludo Cristal, com Gravata Longa que cria efeito cascata ao descer pela árvore ou coluna.", cores:[...cVGBCA,{name:"Lamê Dourado",hex:"#CFB53B",photo:F.lame_dourado,material:"100% poliéster metalizado"}],photo:F.val_gl,...TC.V,sizes:[{label:"30cm",ref:"30VaL",preco:43.00},{label:"40cm",ref:"40VaL",preco:61.90},{label:"50cm",ref:"50VaL",preco:98.90}] },
  { sku:"VDuGV",      name:"Laço Veludo Duplo Gravata V",              subtitle:"100cm",           category:"Veludo",  material:"100% poliéster", acabamento:"Estrutura interna com placa, arame e costura francesa.", prazo:P30, preco:369.00, desc:"Laço confeccionado em Veludo tradicional, com borboleta dupla e gravata em V.", cores:[{name:"Vermelho",hex:"#C0392B"}], photo:"https://res.cloudinary.com/djeliz676/image/upload/v1779990308/laco_gravata_tripla_ekuhtx.jpg", ...TC.V, sizes:[{label:"100cm",ref:"100VDuGV",preco:369.00}] },
  { sku:"VVM",      name:"Laço Veludo Vermelho",                     subtitle:"20cm a 100cm",           category:"Veludo",    material:"100% poliéster",            acabamento:AP,   prazo:P30, preco:PRECO_UN, desc:"O clássico da linha; confeccionado em Veludo tradicional.",                                       cores:[{name:"Vermelho",hex:"#C0392B"}],   photo:F.vvm,         ...TC.V, sizes:[{label:"20cm",ref:"20V",preco:21.90},{label:"30cm",ref:"30V",preco:33.90},{label:"40cm",ref:"40V",preco:46.90},{label:"50cm",ref:"50V",preco:79.90},{label:"80cm",ref:"80V",preco:197.90},{label:"100cm",ref:"100V",preco:269.00}] },
  { sku:"VD",       name:"Laço Veludo Vermelho com Dourado",          subtitle:"Borda ouro",             category:"Estampado", material:"90% poliéster/10% algodão", acabamento:AE,   prazo:P30, preco:PRECO_UN, desc:"Laço confeccionado em Veludo Tradicional, com borda ouro.",                                               cores:cVD,    photo:F.vd,          ...TC.E, sizes:[{label:"20cm",ref:"20VD",preco:24.90},{label:"30cm",ref:"30VD",preco:36.90},{label:"40cm",ref:"40VD",preco:48.90}] },
  { sku:"VFIXDZ",   name:"Laço Veludo Vermelho Fita Xadrez",          subtitle:"Fita xadrez",            category:"Estampado", material:"100% poliéster",            acabamento:AE,   prazo:P30, preco:PRECO_UN, desc:"Laço confeccionado em Veludo Tradicional, com fita xadrez decorativa central.",                          cores:[{name:"Vermelho",hex:"#C0392B"}],    photo:F.vfixdz,      ...TC.E, sizes:[{label:"20cm",ref:"20VFiXdz",preco:26.90},{label:"30cm",ref:"30VFiXdz",preco:38.90},{label:"40cm",ref:"40VFiXdz",preco:56.90}] },
  { sku:"VL",       name:"Laço Veludo Vermelho Listra",               subtitle:"Borda listrada",         category:"Estampado", material:"90% poliéster/10% algodão", acabamento:AE,   prazo:P30, preco:PRECO_UN, desc:"Laço confeccionado em Veludo Tradicional, com borda de listra.",                                         cores:[{name:"Veludo Vermelho + Listra Branca",hex:"#C0392B"}],    photo:F.vl,          ...TC.E, sizes:[{label:"20cm",ref:"20VL",preco:24.90},{label:"30cm",ref:"30VL",preco:36.90},{label:"40cm",ref:"40VL",preco:48.90}] },
  { sku:"XBV",      name:"Laço Tecido Xadrez Borda Veludo",          subtitle:"Xadrez central",         category:"Estampado", material:"100% poliéster",            acabamento:AE,   prazo:P30, preco:PRECO_UN, desc:"Laço tradicional confeccionado em tecido xadrez, com borda em veludo.",                                   cores:[{name:"Vermelho + Xadrez",hex:"#C0392B"}],    photo:F.vxc,         ...TC.E, sizes:[{label:"20cm",ref:"20VXC",preco:27.90},{label:"30cm",ref:"30VXC",preco:39.90},{label:"40cm",ref:"40VXC",preco:53.90}] },
  { sku:"VMinGL",     name:"Laço Veludo Vermelho Min",                 subtitle:"50cm",            category:"Veludo",  material:"100% poliéster", acabamento:"Estrutura interna com placa e costura francesa.", prazo:P30, preco:169.40, desc:"Laço confeccionado em Veludo Cristal, com borboleta tripla e gravata tradicional.", cores:[{name:"Vermelho",hex:"#C0392B"}], photo:"https://res.cloudinary.com/djeliz676/image/upload/v1779991951/vaimin_vtqtgd.jpg", ...TC.V, sizes:[{label:"50cm",ref:"50VMinGL",preco:169.40}] },
  { sku:"VSout",      name:"Laço Veludo Vermelho Soutache",            subtitle:"20cm a 40cm",     category:"Veludo",  material:"100% poliéster", acabamento:"Costura francesa, estrutura interna e soutache dourado.", prazo:P30, preco:32.90, desc:"Laço confeccionado em Veludo tradicional, adornado com fita natalina xadrez e soutache dourado.", cores:[{name:"Vermelho",hex:"#C0392B"}], photo:"https://res.cloudinary.com/djeliz676/image/upload/v1779992238/laco_soutchj_r6ua5b.jpg", ...TC.V, sizes:[{label:"20cm",ref:"20VSout",preco:32.90},{label:"30cm",ref:"30VSout",preco:51.80},{label:"40cm",ref:"40VSout",preco:69.50}] },
  { sku:"VX",       name:"Laço Veludo Vermelho Xadrez",               subtitle:"Borda xadrez",           category:"Estampado", material:"90% poliéster/10% algodão", acabamento:AE,   prazo:P30, preco:PRECO_UN, desc:"Laço confeccionado em Veludo Tradicional, com borda xadrez.",                                            cores:[{name:"Vermelho + Xadrez",hex:"#C0392B"}],    photo:F.vx,          ...TC.E, sizes:[{label:"20cm",ref:"20VX",preco:24.90},{label:"30cm",ref:"30VX",preco:36.90},{label:"40cm",ref:"40VX",preco:48.90}] },
  { sku:"VXCP",      name:"Laço Veludo Vermelho Xadrez/Preto",         subtitle:"Flanela xadrez",         category:"Estampado", material:"100% poliéster",            acabamento:AE,   prazo:P30, preco:PRECO_UN, desc:"Laço com flanela xadrez Vermelho/Preto central.",                                                         cores:cVP,    photo:F.vxp,         ...TC.E, sizes:[{label:"20cm",ref:"20VXP",preco:24.90},{label:"30cm",ref:"30VXP",preco:31.90},{label:"40cm",ref:"40VXP",preco:39.90}] },
  { sku:"BTLT",     name:"Bola Tecido Listrado Decorada",              subtitle:"Listrado Verm/Branco",   category:"Bolas",     material:"Isopor e poliéster",        acabamento:AIS,  prazo:P30, preco:PRECO_UN, desc:"Bola coberta com tecido listrado Vermelho/Branco e decorada com galhos natalinos.",                      cores:cVB,    photo:F.bola_lst,    ...TC.B, sizes:[{label:"15cm",ref:"15BTLt",preco:29.80}] },
  ...
  { sku:"BTXDZP",   name:"Bola Tecido Xadrez Vermelho/Preto",          subtitle:"Xadrez Verm/Preto",      category:"Bolas",     material:"Isopor e poliéster",        acabamento:AIS,  prazo:P30, preco:PRECO_UN, desc:"Bola coberta com tecido Xadrez Vermelho/Preto e decorada com galhos natalinos.",                         cores:cVP,    photo:F.bola_pt,     ...TC.B, sizes:[{label:"15cm",ref:"15BTXdzVm/Pt",preco:29.80}] },
  { sku:"BVAL",     name:"Bola Veludo Ale",                            subtitle:"12cm a 25cm",            category:"Bolas",     material:"Isopor e poliéster",        acabamento:AIS,  prazo:P30, preco:PRECO_UN, desc:"Bola tradicional coberta com veludo cristal.",                                                            cores:[{name:"Vermelho",hex:"#C0392B"},{name:"Verde",hex:"#2D5A27"},{name:"Branco",hex:"#F5F5F0"},{name:"Areia",hex:"#C8B49A"}], photo:F.bola_vm,     ...TC.B, sizes:[{label:"12cm",ref:"12BVAl",preco:19.90},{label:"15cm",ref:"15BVAl",preco:23.20},{label:"20cm",ref:"20BVAl",preco:39.20},{label:"25cm",ref:"25BVAl",preco:49.80}] },
  { sku:"BFCODRLÇ", name:"Bota Feltro Cordeiro Laço",                    subtitle:"50cm",                   category:"Saldão",    material:"100% Poliéster",            acabamento:"",   prazo:P30,  preco:29.80,    desc:"Bota em feltro cordeiro com laço.",                                                                       cores:cNAT,   photo:F.bota_laco_dou,...TC.S,sizes:[{label:"50cm",ref:"50BFCODRLÇ",preco:29.80}] },
  { sku:"BFCCXDZ",  name:"Bota Feltro Cru Cervo Xadrez",               subtitle:"50cm",                   category:"Saldão",    material:"100% Poliéster",            acabamento:"",   prazo:P30,   preco:39.80,    desc:"Bota em feltro cru com cervo xadrez.",                                                                   cores:[{name:"Vermelho",hex:"#C0392B"}],    photo:F.bfccxdz,     ...TC.S, sizes:[{label:"50cm",ref:"50BFCCXDZ",preco:39.80}] },
  { sku:"BFVB",     name:"Bota Feltro Verde Bengala",                   subtitle:"50cm",                   category:"Saldão",    material:"100% Poliéster",            acabamento:"",   prazo:P30,   preco:79.90,    desc:"Bota em feltro verde bengala.",                                                                          cores:cNAT,   photo:F.bfvb,        ...TC.S, sizes:[{label:"50cm",ref:"50BFVB",preco:79.90}] },
  { sku:"BFVDEPX",  name:"Bota Feltro Verde Espinha Peixe",             subtitle:"50cm",                   category:"Saldão",    material:"100% Poliéster",            acabamento:"",   prazo:P30,  preco:49.80,    desc:"Bota em feltro verde espinha de peixe.",                                                                 cores:cNAT,   photo:F.bfvdepx,     ...TC.S, sizes:[{label:"50cm",ref:"50BFVDEPX",preco:49.80}] },
  { sku:"BFVOC",    name:"Bota Feltro Verde Oliva Cervo",               subtitle:"50cm",                   category:"Saldão",    material:"100% Poliéster",            acabamento:"",   prazo:P30,   preco:29.80,    desc:"Bota em feltro verde oliva com cervo.",                                                                  cores:cNAT,   photo:F.bfvoc,       ...TC.S, sizes:[{label:"50cm",ref:"50BFVOC",preco:29.80}] },
  { sku:"BFVO",     name:"Bota Feltro Verde Ossinho",                    subtitle:"50cm",                   category:"Saldão",    material:"100% Poliéster",            acabamento:"",   prazo:P30,   preco:49.80,    desc:"Bota em feltro verde com ossinho.",                                                                       cores:cNAT,   photo:"https://res.cloudinary.com/djeliz676/image/upload/v1780058523/WhatsApp_Image_2026-05-14_at_10.42.38432432_aac4sl.jpg",            ...TC.S, sizes:[{label:"50cm",ref:"50BFVO",preco:49.80}] },
  { sku:"BFVMCPT",  name:"Bota Feltro Vermelho Cachorrinho Preto",      subtitle:"50cm",                   category:"Saldão",    material:"100% Poliéster",            acabamento:"",   prazo:P30,   preco:69.70,    desc:"Bota em feltro vermelho com cachorrinho preto.",                                                         cores:cNAT,   photo:F.bfvmcpt,     ...TC.S, sizes:[{label:"50cm",ref:"50BFVMCPT",preco:69.70}] },
  { sku:"BFVCBR",   name:"Bota Feltro Vermelho Cervo Branco",          subtitle:"50cm",                   category:"Saldão",    material:"100% Poliéster",            acabamento:"",   prazo:P30,  preco:39.80,    desc:"Bota em feltro vermelho com cervo branco.",                                                              cores:[{name:"Vermelho",hex:"#C0392B"}],    photo:F.bfvcbr,      ...TC.S, sizes:[{label:"50cm",ref:"50BFVCBR",preco:39.80}] },
  { sku:"BXFDZP",   name:"Bota Flanelada Xadrez/Pelúcia",              subtitle:"50cm",                   category:"Saldão",    material:"100% Poliéster",            acabamento:"",   prazo:P30,  preco:68.70,    desc:"Bota em tecido flanelado xadrez com pelúcia.",                                                           cores:cNAT,   photo:F.bota_flanela,...TC.S, sizes:[{label:"50cm",ref:"50BXFDZP",preco:68.70}] },
  { sku:"BJCM",     name:"Bota Juta Cervo Madeira",                      subtitle:"50cm",                   category:"Saldão",    material:"100% Poliéster",            acabamento:"",   prazo:P30,   preco:69.50,    desc:"Bota em juta com cervo madeira.",                                                                         cores:cNAT,   photo:"https://res.cloudinary.com/djeliz676/image/upload/v1779739791/bota_reninha_l4tydy.jpg",            ...TC.S, sizes:[{label:"50cm",ref:"50BJCM",preco:69.50}] },
  { sku:"BJR",      name:"Bota Juta Renda",                            subtitle:"50cm",                   category:"Saldão",    material:"100% Poliéster",            acabamento:"",   prazo:P30,   preco:59.80,    desc:"Bota decorativa em Juta com Renda.",                                                                     cores:cNAT,   photo:F.bjr,         ...TC.S, sizes:[{label:"50cm",ref:"50BJR",preco:59.80}] },
  { sku:"BJXDZN",   name:"Bota Juta Xadrez Natalino",                    subtitle:"50cm",                   category:"Saldão",    material:"100% Poliéster",            acabamento:"",   prazo:P30,  preco:69.50,    desc:"Bota em juta com xadrez natalino.",                                                                       cores:cNAT,   photo:F.bjxdzn,      ...TC.S, sizes:[{label:"50cm",ref:"50BJXDZN",preco:69.50}] },
  { sku:"BNDDec",     name:"Bota Natalina Dourada Decorada",           subtitle:"50cm",            category:"Saldão",  material:"90% Poliéster/10% Plástico", acabamento:"Costura francesa, pelúcia e galho natalino.", prazo:P30, preco:89.00, desc:"Bota Natalina 50cm em Veludo Velboa dourado, pelúcia e galho natalino.", cores:cUNI, photo:F.bota_dourada, ...TC.S, sizes:[{label:"50cm",ref:"50BNDDec",preco:89.00}] },
  { sku:"BNNDec",     name:"Bota Natalina Noel Decorada",              subtitle:"50cm",            category:"Saldão",  material:"90% Poliéster/10% Plástico", acabamento:"Costura francesa, pelúcia e galho natalino.", prazo:P30, preco:89.00, desc:"Bota Natalina 50cm em Veludo Velboa, pelúcia e galho natalino.", cores:cUNI, photo:F.bota_alce, ...TC.S, sizes:[{label:"50cm",ref:"50BNNDec",preco:89.00}] },
  { sku:"BNXdzDec",   name:"Bota Natalina Xadrez Decorada",            subtitle:"50cm",            category:"Saldão",  material:"100% Poliéster", acabamento:"Costura francesa e pelúcia.", prazo:P30, preco:89.00, desc:"Bota Natalina 50cm em Flanela Xadrez, pelúcia e galho natalino.", cores:cUNI, photo:F.bota_pelucia_dec, ...TC.S, sizes:[{label:"50cm",ref:"50BNXdzDec",preco:89.00}] },
  { sku:"BVVm",     name:"Bota Velboa Vermelho 50cm",                    subtitle:"50cm",                   category:"Saldão",    material:"100% Poliéster",            acabamento:ACFP, prazo:P30,   preco:19.90,    desc:"Bota Natalina 50cm em Veludo Velboa e pelúcia.",                                                         cores:cUNI,   photo:F.bota_bolinha,...TC.S, sizes:[{label:"50cm",ref:"50BVVm",preco:19.90}] },
  { sku:"BVPArDr",  name:"Bota Velboa/Pelúcia Árvore",                   subtitle:"50cm",                   category:"Saldão",    material:"100% Poliéster",            acabamento:"",   prazo:P30,  preco:34.80,    desc:"Bota em velboa/pelúcia com árvore.",                                                                      cores:cNAT,   photo:"https://res.cloudinary.com/djeliz676/image/upload/v1779740019/bota_arvore_mp9hpw.jpg",            ...TC.S, sizes:[{label:"50cm",ref:"50BVPArDr",preco:34.80}] },
  { sku:"BFVPACH",  name:"Bota Velboz Patchwork",                        subtitle:"50cm",                   category:"Saldão",    material:"100% Poliéster",            acabamento:"",   prazo:P30,  preco:49.70,    desc:"Bota em velboz estilo patchwork.",                                                                        cores:cNAT,   photo:"https://res.cloudinary.com/djeliz676/image/upload/v1779740460/bota_lacinho_djz698.jpg",            ...TC.S, sizes:[{label:"50cm",ref:"50BFVPACH",preco:49.70}] },
  { sku:"RNL",      name:"Roupa Noel Luxo",                              subtitle:"Tam. GG",                category:"Saldão",    material:"95% poliéster, 5% vinil",   acabamento:"",   prazo:P30, preco:320.00,        desc:"Roupa do Papai Noel luxo em feltro e pelúcia.",                                                          cores:cUNI,   photo:F.roupa_noel,  ...TC.S, sizes:[{label:"GG",ref:"RNL",preco:320.00}] },
  ...
  { sku:"SFOS",     name:"Saia Feltro Organza Sextavada",                subtitle:"80cm / 100cm",           category:"Saldão",    material:"100% Poliéster",            acabamento:"",   prazo:P30,  preco:69.40,    desc:"Saia para árvore em feltro com organza sextavada.",                                                      cores:cNAT,   photo:F.sfos,        ...TC.S, sizes:[{label:"80cm",ref:"80SFOS",preco:69.40},{label:"100cm",ref:"1SFOS",preco:79.60}] },
  { sku:"SFVVArv",  name:"Saia Feltro Vermelho e Verde Árvore",          subtitle:"80 a 120cm",             category:"Saldão",    material:"100% Poliéster",            acabamento:"Costura francesa, sianinha e botão.",      prazo:P30,  preco:19.90,    desc:"Saia Natalina em Feltro, aplicação árvores Patchwork e sianinha.",       cores:cUNI,   photo:F.saia_arvore, ...TC.S, sizes:[{label:"80cm",ref:"80SFVVArv",preco:59.70},{label:"100cm",ref:"100SFVVArv",preco:66.60},{label:"120cm",ref:"120SFVVArv",preco:75.80}] },
  { sku:"SNFC",     name:"Saia Natalina Feltro Coruja",                  subtitle:"100cm",                  category:"Saldão",    material:"100% Poliéster",            acabamento:"Costura francesa, viés e velcro.",         prazo:P30,   preco:79.80,    desc:"Saia Verde Musgo 100cm em Feltro, aplicação Coruja e galho.",            cores:cUNI,   photo:F.saia_coruja, ...TC.S, sizes:[{label:"100cm",ref:"100SNFC",preco:79.80}] },
  { sku:"SNNCxP",   name:"Saia Natalina Noel Caixa Presente",            subtitle:"60 a 100cm",             category:"Saldão",    material:"100% Poliéster",            acabamento:"Cianinha vermelha e botão.",               prazo:P30,  preco:32.90,    desc:"Saia Natalina em Feltro, com aplicação Noel e Caixas Presente.",         cores:cUNI,   photo:F.saia_cx_noel,...TC.S, sizes:[{label:"60cm",ref:"60SNNCxP",preco:32.90},{label:"80cm",ref:"80SNNCxP",preco:37.90},{label:"100cm",ref:"100SNNCxP",preco:42.90}] },
  { sku:"SNPop",    name:"Saia Natalina POP Árvore",                     subtitle:"60 a 120cm",             category:"Saldão",    material:"100% Poliéster",            acabamento:"Cianinha branca e botão.",                 prazo:P30,  preco:29.90,    desc:"Saia Natalina em Feltro, com aplicação Árvores.",                        cores:cUNI,   photo:"https://res.cloudinary.com/djeliz676/image/upload/v1779888440/saia_arvore_4_rvrseu.jpg",...TC.S,sizes:[{label:"60cm",ref:"60SNPop",preco:29.90},{label:"80cm",ref:"80SNPop",preco:34.90},{label:"100cm",ref:"100SNPop",preco:39.90},{label:"120cm",ref:"120SNPop",preco:45.90}] },
  { sku:"SNSor",    name:"Saia Natalina Sortida",                        subtitle:"60 a 120cm",            category:"Saldão",    material:"100% Poliéster",            acabamento:"Costura francesa, pelúcia e fivela.",      prazo:P30, preco:18.90, desc:"Saia Natalina em Organza e Cetim, estampada em Verde, Vermelho, Dourado e Branco.", cores:cVMulti,photo:F.saias_var,...TC.S,sizes:[{label:"60cm",ref:"60SNSor",preco:18.90},{label:"80cm",ref:"80SNSor",preco:24.90},{label:"100cm",ref:"100SNSor",preco:29.00},{label:"120cm",ref:"120SNSor",preco:34.90}] },
  { sku:"SVVBBR",   name:"Saia Velboa Vermelho Bolas Pelúcia",           subtitle:"100cm",                  category:"Saldão",    material:"100% Poliéster",            acabamento:"",   prazo:P30, preco:69.90,        desc:"Saia para árvore em velboa vermelho com bolas de pelúcia.",                                              cores:cNAT,   photo:F.saia_bola_pel,...TC.S,sizes:[{label:"100cm",ref:"1SVVBBR",preco:69.90}] },
  { sku:"SVVmBr",   name:"Saia Velboa Vermelho e Branco",                subtitle:"50 e 60cm",              category:"Saldão",    material:"100% Poliéster",            acabamento:"Cianinha branca.",                         prazo:P30,   preco:24.90,    desc:"Saia Natalina Veludo Velboa e Pelúcia, aplicação cianinha.",              cores:cUNI,   photo:F.saia_velb_pol,...TC.S,sizes:[{label:"50cm",ref:"50SVVmBr",preco:24.90},{label:"60cm",ref:"60SVVmBr",preco:29.90}] },
  { sku:"SFCCXD",   name:"Saia Árvore Feltro Cru Cervo Xadrez",        subtitle:"1MT",                    category:"Saldão",    material:"100% Poliéster",            acabamento:"",   prazo:P30,   preco:89.60,    desc:"Saia para árvore em feltro cru com cervo xadrez.",                                                       cores:[{name:"Vermelho",hex:"#C0392B"}],    photo:F.sfccxd,      ...TC.S, sizes:[{label:"1MT",ref:"1SFCCXD",preco:89.60}] },
  { sku:"SFVGPT",   name:"Saia Árvore Feltro Gatinho Preto",            subtitle:"1MT",                    category:"Saldão",    material:"100% Poliéster",            acabamento:"",   prazo:P30,   preco:119.40,   desc:"Saia para árvore em feltro com gatinho preto.",                                                          cores:cNAT,   photo:F.sfvgpt,      ...TC.S, sizes:[{label:"1MT",ref:"1SFVGPT",preco:119.40}] },
  { sku:"SFG",      name:"Saia Árvore Feltro Gnomo",                     subtitle:"100cm",                  category:"Saldão",    material:"100% Poliéster",            acabamento:"",   prazo:P30,   preco:79.50,    desc:"Saia para árvore em feltro com gnomo.",                                                                  cores:cNAT,   photo:"https://res.cloudinary.com/djeliz676/image/upload/v1779740140/saia_gnomo_ff6t78.jpg",            ...TC.S, sizes:[{label:"100cm",ref:"1SFG",preco:79.50}] },
  { sku:"SFPN",     name:"Saia Árvore Feltro Papai Noel",                subtitle:"100cm",                  category:"Saldão",    material:"100% Poliéster",            acabamento:"",   prazo:P30,   preco:89.30,    desc:"Saia para árvore em feltro com Papai Noel.",                                                             cores:cNAT,   photo:F.saia_noel,   ...TC.S, sizes:[{label:"100cm",ref:"1SFPN",preco:89.30}] },
  { sku:"SFVDB",    name:"Saia Árvore Feltro Verde Bengala",            subtitle:"1MT",                    category:"Saldão",    material:"100% Poliéster",            acabamento:"",   prazo:P30,   preco:129.60,   desc:"Saia para árvore em feltro verde bengala.",                                                              cores:cNAT,   photo:F.sfvdb,       ...TC.S, sizes:[{label:"1MT",ref:"1SFVDB",preco:129.60}] },
  { sku:"SFVEP",    name:"Saia Árvore Feltro Verde Espinha Peixe",      subtitle:"1MT",                    category:"Saldão",    material:"100% Poliéster",            acabamento:"",   prazo:P30,   preco:79.50,    desc:"Saia para árvore em feltro verde espinha de peixe.",                                                     cores:cNAT,   photo:"https://res.cloudinary.com/djeliz676/image/upload/v1780058374/saia_espinha_1_sq4fqk.jpg",            ...TC.S, sizes:[{label:"1MT",ref:"1SFVEP",preco:79.50}] },
  { sku:"SFVOC",    name:"Saia Árvore Feltro Verde Oliva Cervo",        subtitle:"1MT",                    category:"Saldão",    material:"100% Poliéster",            acabamento:"",   prazo:P30,   preco:79.30,    desc:"Saia para árvore em feltro verde oliva com cervo e guizo.",                                              cores:cNAT,   photo:F.sfvoc,       ...TC.S, sizes:[{label:"1MT",ref:"1SFVOC",preco:79.30}] },
  { sku:"SFVCPT",   name:"Saia Árvore Feltro Vermelho Cachorro Preto",  subtitle:"1MT",                    category:"Saldão",    material:"100% Poliéster",            acabamento:"",   prazo:P30,   preco:129.40,   desc:"Saia para árvore em feltro vermelho com cachorrinho preto.",                                             cores:cNAT,   photo:F.sfvcpt,      ...TC.S, sizes:[{label:"1MT",ref:"1SFVCPT",preco:129.40}] },
  { sku:"SFVCBR",   name:"Saia Árvore Feltro Vermelho Cervo Branco",   subtitle:"1MT",                    category:"Saldão",    material:"100% Poliéster",            acabamento:"",   prazo:P30,   preco:89.60,    desc:"Saia para árvore em feltro vermelho com cervo branco.",                                                  cores:[{name:"Vermelho",hex:"#C0392B"}],    photo:F.sfvcbr,      ...TC.S, sizes:[{label:"1MT",ref:"1SFVCBR",preco:89.60}] },
  { sku:"SFXDP",    name:"Saia Árvore Flanelada Xadrez/Pelúcia",       subtitle:"1MT",                    category:"Saldão",    material:"100% Poliéster",            acabamento:"",   prazo:P30,   preco:104.30,   desc:"Saia para árvore em tecido flanelado xadrez com pelúcia.",                                               cores:[{name:"Vermelho",hex:"#C0392B"}],    photo:F.saia_xdz_rosa,...TC.S,sizes:[{label:"1MT",ref:"1SFXDP",preco:104.30}] },
  { sku:"SVVPN",    name:"Saia Árvore Velboa Vermelho Papai Noel",       subtitle:"80/100/120cm",           category:"Saldão",    material:"100% Poliéster",            acabamento:"",   prazo:P30,  preco:59.00,    desc:"Saia para árvore em velboa vermelho com Papai Noel.",                                                    cores:cNAT,   photo:F.saia_noel_vm,...TC.S, sizes:[{label:"80cm",ref:"80SVVPN",preco:59.00},{label:"100cm",ref:"100SVVPN",preco:64.00},{label:"120cm",ref:"120SVVPN",preco:69.00}] },
  { sku:"SFVO",     name:"Saia Árvore Vermelho Ossinho",                 subtitle:"1MT",                    category:"Saldão",    material:"100% Poliéster",            acabamento:"",   prazo:P30,   preco:79.50,    desc:"Saia para árvore em feltro vermelho com ossinho.",                                                       cores:cNAT,   photo:F.saia_ossinho,...TC.S, sizes:[{label:"1MT",ref:"1SFVO",preco:79.50}] },
  { sku:"KitNatB30",name:"Kit Bota Natalina Sortidas 30cm",              subtitle:"Kit 5 pçs · 30cm",      category:"Saldão",    material:"100% Poliéster",            acabamento:"Costura francesa, pelúcia e fivela.",      prazo:P30,  preco:29.50, desc:"Kit com 5 Botas Natalinas 30cm.",                                       cores:cVMulti,photo:F.kit_bota_30,  ...TC.K, sizes:[{label:"30cm",ref:"KitNatB30",preco:29.50}] },
  { sku:"KitNatB35",name:"Kit Bota Natalina Sortidas 35cm",              subtitle:"Kit 5 pçs · 35cm",      category:"Saldão",    material:"100% Poliéster",            acabamento:"Costura francesa, pelúcia e fivela.",      prazo:P30,  preco:39.50, desc:"Kit com 5 Botas Natalinas 35cm em organza, feltro e pelúcia.",          cores:cVMulti,photo:F.kit_bota_35,  ...TC.K, sizes:[{label:"35cm",ref:"KitNatB35",preco:39.50}] },
  { sku:"KitNatB50",name:"Kit Bota Natalina Sortidas 50cm",              subtitle:"Kit 5 pçs · 50cm",      category:"Saldão",    material:"100% Poliéster",            acabamento:"Costura francesa, pelúcia e soutache.",    prazo:P30,   preco:49.00, desc:"Kit com 5 Botas Natalinas 50cm em organza, veludo velboa e feltro.",     cores:cVMulti,photo:F.kit_bota_nat, ...TC.K, sizes:[{label:"50cm",ref:"KitNatB50",preco:49.00}] },
  { sku:"KitNat5",  name:"Kit Figuras Natalinas Sortidas",               subtitle:"Kit 5 pçs",             category:"Saldão",    material:"100% Poliéster",            acabamento:"Costura francesa, pelúcia, soutache e botão.", prazo:P30,   preco:25.00, desc:"Kit com 5 pçs: casaco, calça, bota, gorro, estrela e árvore.",          cores:cVNDou, photo:F.kit_figuras, ...TC.K, sizes:[{label:"Kit 5",ref:"KitNat5",preco:25.00}] },
  { sku:"KitRN4",   name:"Kit Roupa Noel Sortida",                       subtitle:"Kit 4 pçs",             category:"Saldão",    material:"100% Poliéster",            acabamento:"Costura francesa, pelúcia e fivela.",      prazo:P30,   preco:28.00, desc:"Kit com 4 pçs: casaco e calça em feltro e pelúcia.",                    cores:cVNude, photo:F.kit_noel_sort,...TC.K,sizes:[{label:"Kit 4",ref:"KitRN4",preco:28.00}] },
  { sku:"KitVN2",   name:"Kit Varalzinho Natalino",                      subtitle:"Kit 2 pçs · 150cm",     category:"Saldão",    material:"100% Poliéster",            acabamento:"Costura francesa, pelúcia e fivela.",      prazo:P30,  preco:39.80, desc:"Kit com 2 pçs: Varalzinho 1,50mt em feltro e pelúcia.",                  cores:cVNude, photo:F.kit_varal,   ...TC.K, sizes:[{label:"150cm",ref:"KitVN2",preco:39.80}] }
];


const CATEGORIES = ["Todos", "Veludo", "Lamê", "Estampado", "Bolas", "Saldão"];
const VENDEDORES  = ["Alexandra", "Valéria", "Cleuza", "Van"];
const SHEETS_URL  = "https://script.google.com/macros/s/AKfycbxy8wm7fBj3Z-2dg8HR7JAuU45OJ4-lyg4Y88dCm7i-76ygQQM78YL25yEO0BlH18czQg/exec";
...
// JSONP — só para LEITURA (listar / snapshot)
...
const QuickAdd = memo(({ product: p, onAdd }) => {
  ...
  if (!open) return (
    <button className="card-btn-add" onClick={e => { e.stopPropagation(); setOpen(true); }}
      style={{ background: VERDE, color: "#fff", cursor: "pointer" }}>
      {"+ ADICIONAR"}
    </button>
  );
        ...
        <div style={{ padding: "18px 18px 44px" }}>
          ...
          {p.acabamento && (
            <div style={{ background: VERDES, borderRadius: 12, padding: "10px 14px", marginBottom: 14, border: `1px solid ${VERDE}22` }}>
              ...
              {[{ l: "Composição", v: cor?.material || p.material }, { l: "Acabamento", v: p.acabamento }, { l: "Prazo", v: p.prazo }].map((r, i, a) => (
...
const PedidosScreen = memo(({ onBack }) => {
  ...
  const handleAbrirPDF = async (pedidoRow) => {
    ...
    try {
      ...
      if (snap) { const obj = parsearSnapshot(JSON.stringify(snap)); if (obj) { setPdfLoading(null); abrirPDF(obj); return; } }
    } catch {}
    // ETAPA 2: action=snapshot
    const d2 = await jsonp(`${SHEETS_URL}?action=snapshot&pedido=${encodeURIComponent(nr)}`);
    if (d2) { const obj2 = parsearSnapshot(d2.snapshot || extrairRawSnapshot(d2)); if (obj2) { setPdfLoading(null); abrirPDF(obj2); return; } }
    // ETAPA 3: reconstrução do texto
              ...
              <div key={idx} style={{ background: CARD, borderRadius: 14, border: `1px solid ${BORDER}`, overflow: "hidden", boxShadow: "0 1px 4px rgba(0,0,0,0.05)" }}>
                ...
                {open && (
                  <div style={{ background: CARD2, padding: "14px 16px", borderTop: `1px solid ${BORDER}` }}>
                    {/* Botão PDF */}
                    <button
                      onClick={() => !pdfLoading && handleAbrirPDF(p)}
                      disabled={!!pdfLoading}
                      style={{ width: "100%", background: pdfLoading === nr ? "#888" : VINHO, color: "#fff", padding: "11px", borderRadius: 10, border: "none", cursor: pdfLoading === nr ? "not-allowed" : "pointer", fontFamily: "'DM Sans',sans-serif", fontSize: 12, fontWeight: 700, marginBottom: 12, display: "flex", alignItems: "center", justifyContent: "center", gap: 6 }}>
                      {pdfLoading === nr ? "⏳ Gerando PDF..." : "🖨️ ABRIR / IMPRIMIR PDF"}
                    </button>
